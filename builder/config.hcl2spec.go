...
type FlatConfig struct {
	...
	Disk                      *int              `mapstructure:"disk" cty:"disk" hcl:"disk"`
	Network                   *string           `mapstructure:"network" cty:"network" hcl:"network"`
	Image                     *string           `mapstructure:"image" cty:"image" hcl:"image"`
	PullImage                 *string           `mapstructure:"pull_image" cty:"pull_image" hcl:"pull_image"`
	PullUsername              *string           `mapstructure:"pull_username" cty:"pull_username" hcl:"pull_username"`
	PullPassword              *string           `mapstructure:"pull_password" cty:"pull_password" hcl:"pull_password"`
	PullCredential            *string           `mapstructure:"pull_credential_id" cty:"pull_credential_id" hcl:"pull_credential_id"`
	...
	PushCredential            *string           `mapstructure:"push_credential_id" cty:"push_credential_id" hcl:"push_credential_id"`
	PushPrecache              *bool             `mapstructure:"push_precache" cty:"push_precache" hcl:"push_precache"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"disk":                         &hcldec.AttrSpec{Name: "disk", Type: cty.Number, Required: false},
		"network":                      &hcldec.AttrSpec{Name: "network", Type: cty.String, Required: false},
		"image":                        &hcldec.AttrSpec{Name: "image", Type: cty.String, Required: false},
		"pull_image":                   &hcldec.AttrSpec{Name: "pull_image", Type: cty.String, Required: false},
		"pull_username":                &hcldec.AttrSpec{Name: "pull_username", Type: cty.String, Required: false},
		"pull_password":                &hcldec.AttrSpec{Name: "pull_password", Type: cty.String, Required: false},
		"pull_credential_id":           &hcldec.AttrSpec{Name: "pull_credential_id", Type: cty.String, Required: false},
		...
		"push_credential_id":           &hcldec.AttrSpec{Name: "push_credential_id", Type: cty.String, Required: false},
		"push_precache":                &hcldec.AttrSpec{Name: "push_precache", Type: cty.Bool, Required: false},
